...
function sampleAcquired(s){   
            ...
            // BUSCA ESTA PARTE EN TU CÓDIGO (CAMBIO PARA REGISTRAR LA LUNEA EN LA BASE DE DATOS)
        ...
        localStorage.setItem("intermediate", "");
        var samples = JSON.parse(s.samples);
        var sampleData = Fingerprint.b64UrlTo64(samples[0].Data); // <--- AQUÍ YA TIENES EL TEXTO
        
        // ==========================================================
        // AGREGA ESTAS LÍNEAS AQUÍ:
        // ==========================================================
        alert("ESTE ES EL TEXTO PARA TU BASE DE DATOS:\n\n" + sampleData);
        console.log("Copia este texto para tu BD:", sampleData);
        // ==========================================================
