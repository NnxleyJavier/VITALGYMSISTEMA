...
<head>
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/es6-shim/0.35.6/es6-shim.min.js" integrity="sha512-Dg4/CQIVodnIqfhuUCPVn/xyyJqlq/CUXqkU1H/nOwpE+bkxv7sxE+CbsM8fvT0EbLJJtAJGfX6X0OATs/kOqA==" crossorigin="anonymous" referrerpolicy="no-referrer"></script>
...
<meta charset="UTF-8">
    <title>Captura de Huella - CodeIgniter 4</title>



    <script src="<?= base_url('assets/js/websdk.client.bundle.min.js') ?>"></script>
    <script src="<?= base_url('assets/js/fingerprint.sdk.min.js') ?>"></script>
