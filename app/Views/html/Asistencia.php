...
<div class="kiosco-wrapper">
    <div class="card-acceso" style="border-top: 6px solid #2ecc71;"> <h2 class="titulo-kiosco">ASISTENCIA STAFF</h2>
        <span class="subtitulo">Escanea tu huella para registrar entrada/salida</span>
        ...
        <h4 id="estadoTexto" style="font-weight: 600; color: #666; margin-top: 20px;">Toca la huella para registrarte</h4>
        <p class="text-muted" style="font-size: 12px; margin-top: 10px;">Control de Personal v1.0</p>
    </div>
</div>
    ...
    <div class="modal-dialog modal-sm" role="document" style="margin-top: 15vh;">
        <div class="modal-content modal-content-custom">
            <div id="modalHeader" class="modal-header-custom">
                ...
                <h3 id="modalTitulo" style="font-weight: 800; margin: 0;">¡Registro Exitoso!</h3>
            </div>
            <div class="modal-body-custom">
                <h4 id="nombreUsuario" style="margin-top: 5px; font-weight: 600;">Nombre del Empleado</h4>
                <p id="rolUsuario" style="color: #000000;">Administrador</p>
                 <p id="fechaHoraRegistro" style="color: #000000;">Fecha y hora de registro</p>
                <hr>
                
                <div id="infoAsistencia">
                    <small style="text-transform: uppercase; letter-spacing: 1px; color: #888;" id="tipoRegistroTexto">Hora de registro</small>
                    <div class="dias-restantes-num" id="horaRegistro" style="font-size: 40px; color: #2ecc71;">00:00</div>
                </div>

                <div id="infoError" style="display: none;">
                    <p id="mensajeError" style="font-weight: bold; font-size: 18px; color: #c62828; margin-top: 20px;">Huella no reconocida</p>
                </div>
                <br>
...
<script src="<?= base_url('assets/js/kiosco2.js') ?>"></script>